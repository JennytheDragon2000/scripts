...
class HtmlDialect(Dialect):
    ...
    def __init__(self, indent=4):
        ...
        self.shortcuts = {
            "cc:ie": {"opening_tag": "<!--[if IE]>", "closing_tag": "<![endif]-->"},
            "cc:ie8": {
            ...
            "html:4t": {
                "expand": True,
                "opening_tag": '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">\n'
                + '<html lang="en">\n'
                + "<head>\n"
                + (" " * self.indent)
            ...
            "html:4s": {
                "expand": True,
                "opening_tag": '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">\n'
                + '<html lang="en">\n'
                + "<head>\n"
                + (" " * self.indent)
                + '<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />\n'
            ...
            "html:xt": {
                "expand": True,
                "opening_tag": '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">\n'
            ...
            "html:xs": {
                "expand": True,
                "opening_tag": '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">\n'
                + '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">\n'
                + "<head>\n"
                + (" " * self.indent)
                + '<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />\n'
            ...
            "html:xxs": {
                "expand": True,
                "opening_tag": '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">\n'
                + '<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">\n'
                + "<head>\n"
                + (" " * self.indent)
                + '<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />\n'
...
class Parser:
    ...
    def render(self):
        ...
        if self.options.has("no-last-newline") or self.prefix or self.suffix:
            output = re.sub(r"\n\s*$", "", output)
    ...
    def render(self):
        ...
        if (
            ...
            # Uh..
                ...
                self.name != ""
                or self.opening_tag is not None
                or self.closing_tag is not None
            ):
                output = (
                    start_guide
                    + indent
...
class Token:
    ...
    def _init_element(self):
        ...
        # Get the ID
        id = None
        for id in re.findall(r"#([\$a-zA-Z0-9_\-\&]+)", self.str):
            pass
        if id is not None:
        ...
        multiplier = None
        for multiplier in re.findall(r"\*\s*([0-9]+)", self.str):
            pass
        ...
        flags = None
        for flags in re.findall(r"[\+\!]+$", self.str):
            pass
...
class Options:
    ...
    cmdline_keys = [
        ...
        (
            "",
            "open-empty-tags",
            "leaves an empty space between empty tags instead of leaving them on one line",
        ),
    ]
